...
<li><strong>Web Development:</strong>React, Styled Components, Redux, Tailwind, API's, React-Query, Axios, Zustand.</li>
<li><strong>Frameworks:</strong> Next.js </li>
<li><strong>Tooling :</strong>Github, Git, Gitlab </li>
</ul>   
